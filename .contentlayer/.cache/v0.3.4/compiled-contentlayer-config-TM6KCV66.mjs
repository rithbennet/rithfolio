...
var Post = defineDocumentType(() => ({
  ...
  fields: {
    ...
    coverImageSrc: { type: "string", required: false },
    // Raw path from frontmatter
  ...
  computedFields: {
    ...
    coverImage: {
      ...
      resolve: (doc) => {
        if (!doc.coverImageSrc)
          return void 0;
        const slug = doc._raw.flattenedPath.replace(/^posts\//, "");
        if (doc.coverImageSrc.startsWith("./") || !doc.coverImageSrc.startsWith("/")) {
...
//# sourceMappingURL=compiled-contentlayer-config-TM6KCV66.mjs.map
